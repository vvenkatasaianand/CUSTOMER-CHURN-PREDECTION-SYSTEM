...
class Settings(BaseSettings):
    ...
    # CORS (comma-separated origins recommended)
    ...
    # Upload limits (basic guardrail; detailed enforcement happens in route logic)
    max_upload_mb: int = Field(default=25, alias="MAX_UPLOAD_MB")

    # Runtime storage directories (default under backend/)
